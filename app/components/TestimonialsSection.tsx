    ...
    <section className="relative w-full py-32 md:py-48 flex items-center justify-center min-h-[800px] mt-12 bg-transparent">
        ...
        <div className="absolute inset-0 mx-auto max-w-[1400px]">
          {TESTIMONIALS.map((t, idx) => (
            <motion.div
              ...
              className={`absolute w-[280px] md:w-[320px] rounded-2xl backdrop-blur-md p-5 ${t.className} ${t.blur ? 'blur-[3px]' : ''}`}
            >
              <h4
                className="text-[1.05rem] font-bold tracking-tight leading-tight mb-2"
      ...
      <div className="relative z-10 mx-auto max-w-2xl flex flex-col items-center text-center px-5">
        <motion.h2 
          ...
          className="text-[2.25rem] md:text-[3.5rem] leading-[1.1] font-medium tracking-tight"
        ...
        <motion.p 
          ...
          className="mt-6 text-[1.1rem] max-w-md"
          style={{ color: isDark ? '#94a3b8' : '#64748b' }}
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="mt-8 flex items-center gap-2 rounded-full px-6 py-2.5 text-sm font-medium shadow-sm transition-all hover:shadow-md"
          style={{
            border: `1px solid ${isDark ? 'rgba(55,65,81,1)' : 'rgba(226,232,240,1)'}`,
