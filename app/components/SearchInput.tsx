    ...
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-center">
        <form onSubmit={handleSubmit} className="relative w-full max-w-[480px]">
          ...
          <div className="group relative flex h-[60px] w-full items-center overflow-hidden rounded-[2rem] bg-[#535B69] p-1.5 shadow-sm transition-all duration-300 focus-within:bg-[#48505E] focus-within:shadow-[0_8px_24px_rgba(0,0,0,0.12)] dark:bg-[#1e2838] dark:focus-within:bg-[#253245] dark:focus-within:shadow-[0_8px_24px_rgba(0,0,0,0.3)]">
            ...
            <motion.button
              ...
              className={`relative flex h-[48px] w-[56px] items-center justify-center overflow-hidden rounded-[26px] transition-all duration-300 ${
                loading || !url.trim()
                  ...
                  : 'bg-white text-[#535B69] dark:text-[#1e2838] hover:bg-slate-50 dark:hover:bg-slate-200 hover:scale-[1.03] shadow-sm'
              }`}
            >
          ...
          <div className="mt-5 flex items-center justify-center gap-2.5 text-[0.85rem] font-medium text-slate-400 dark:text-slate-500">
            <span>Try:</span>
            <div className="flex gap-2">
              {['stripe.com', 'linear.app', 'vercel.com'].map((domain) => (
                <button
                  ...
                  className="rounded-md px-1.5 py-0.5 transition-colors hover:text-slate-800 dark:hover:text-slate-200"
                >
                  {domain}
                </button>
              ))}
