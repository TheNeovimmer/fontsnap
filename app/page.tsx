      ...
      <div className="relative z-10 w-full">
        ...
        <section className="mt-24 w-full px-5 md:px-8 mb-32">
          <div className="mx-auto w-full max-w-3xl flex flex-col items-center text-center">
            ...
            <h2 className="text-[1.75rem] font-medium tracking-tight md:text-[2.25rem] text-[var(--text-1)]">
              How it works
            </h2>
        ...
        >
          <div className="mx-auto w-full max-w-6xl flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex items-center justify-center gap-2 text-[0.8rem] text-[var(--text-3)]">
              ...
              <span>Created by <a href="https://github.com/TheNeovimmer" target="_blank" rel="noopener noreferrer" className="hover:underline transition-colors hover:text-[var(--text-1)]">TheNeovimmer</a></span>
            </div>
          </div>
        </footer>
      </div>
