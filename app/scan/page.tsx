    ...
    >
      ...
      {elapsedMs >= 12000 && (
        <div className="flex flex-col items-center gap-2.5 text-center">
          <p className="max-w-[380px] text-[13px] text-[#6b7f98] dark:text-[#8a9bb5]">
            {elapsedMs >= 60000
          ...
          {elapsedMs >= 60000 && (
            <button
              type="button"
              onClick={onCancel}
              className="scan-focusable rounded-full border border-[var(--scan-line-1)] bg-white dark:bg-slate-800 px-5 py-2 text-[13px] font-semibold text-[var(--scan-ink-2)] transition-colors duration-[140ms] hover:border-[#bccde4] dark:hover:border-slate-600 hover:text-[var(--scan-ink-1)]"
            >
      ...
      <div className="flex flex-wrap items-center justify-center gap-2.5">
        <button
          ...
          onClick={primary.onClick}
              className="scan-focusable rounded-full bg-[var(--scan-accent)] px-6 py-2.5 text-[13.5px] font-semibold text-white transition-[background-color,box-shadow] duration-[140ms] hover:bg-[var(--scan-accent-deep)] hover:shadow-[0_6px_18px_-8px_rgba(29,98,221,0.55)] dark:hover:shadow-[0_6px_18px_-8px_rgba(77,138,240,0.55)] active:scale-[0.98]"
        >
          {primary.label}
        </button>
        <button
          ...
          onClick={secondary.onClick}
              className="scan-focusable rounded-full border border-[var(--scan-line-1)] bg-white dark:bg-slate-800 px-6 py-2.5 text-[13.5px] font-semibold text-[var(--scan-ink-2)] transition-colors duration-[140ms] hover:border-[#bccde4] dark:hover:border-slate-600 hover:text-[var(--scan-ink-1)] active:scale-[0.98]"
        >
          {secondary.label}
        </button>
      </div>
...
function ScanBar({
  ...
  return (
    <motion.nav
      ...
      className="sticky top-0 z-50 border-b border-[rgba(215,226,241,0.65)] dark:border-[rgba(30,40,56,0.65)] bg-[rgba(243,247,253,0.72)] dark:bg-[rgba(12,16,24,0.72)] backdrop-blur-[14px]"
    >
      <div className="mx-auto flex h-15 w-full max-w-[1180px] items-center justify-between gap-4 px-5 py-3 md:px-8">
        <button
          type="button"
          onClick={onBack}
              className="scan-focusable group flex h-9 items-center gap-2 rounded-full border border-[var(--scan-line-1)] bg-white/80 dark:bg-slate-800/80 pl-2.5 pr-4 text-[12.5px] font-medium text-[var(--scan-ink-2)] transition-[background-color,border-color,color] duration-[140ms] hover:border-[#bccde4] dark:hover:border-slate-600 hover:bg-white dark:hover:bg-slate-700 hover:text-[var(--scan-ink-1)] active:scale-[0.98]"
        >
          <svg
...
function ScanSuspenseFallback() {
  return (
    <div className="scan-page min-h-screen pb-24 text-[var(--scan-ink-1)]">
      <div className="sticky top-0 z-50 border-b border-[rgba(215,226,241,0.6)] dark:border-[rgba(30,40,56,0.6)] bg-[rgba(247,250,255,0.82)] dark:bg-[rgba(12,16,24,0.82)] backdrop-blur-[16px]">
